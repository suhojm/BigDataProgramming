...
public class WordStatisticData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WordStatisticData\",\"namespace\":\"com.refactorlabs.cs378.assign5\",\"fields\":[{\"name\":\"document_count\",\"type\":\"long\"},{\"name\":\"total_count\",\"type\":\"long\"},{\"name\":\"sum_of_squares\",\"type\":\"long\"},{\"name\":\"mean\",\"type\":\"double\"},{\"name\":\"variance\",\"type\":\"double\"}]}");
   ...
   */
  public WordStatisticData() {}

  /**
   * All-args constructor.
   */
  public WordStatisticData(java.lang.Long document_count, java.lang.Long total_count, java.lang.Long sum_of_squares, java.lang.Double mean, java.lang.Double variance) {
  ...
  /** Creates a new WordStatisticData RecordBuilder */
  public static com.refactorlabs.cs378.assign5.WordStatisticData.Builder newBuilder() {
    return new com.refactorlabs.cs378.assign5.WordStatisticData.Builder();
  }
  
  /** Creates a new WordStatisticData RecordBuilder by copying an existing Builder */
  public static com.refactorlabs.cs378.assign5.WordStatisticData.Builder newBuilder(com.refactorlabs.cs378.assign5.WordStatisticData.Builder other) {
    return new com.refactorlabs.cs378.assign5.WordStatisticData.Builder(other);
  }
  
  /** Creates a new WordStatisticData RecordBuilder by copying an existing WordStatisticData instance */
  public static com.refactorlabs.cs378.assign5.WordStatisticData.Builder newBuilder(com.refactorlabs.cs378.assign5.WordStatisticData other) {
    return new com.refactorlabs.cs378.assign5.WordStatisticData.Builder(other);
  }
  
  /**
   * RecordBuilder for WordStatisticData instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WordStatisticData>
    implements org.apache.avro.data.RecordBuilder<WordStatisticData> {
    ...
    private Builder() {
      super(com.refactorlabs.cs378.assign5.WordStatisticData.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.refactorlabs.cs378.assign5.WordStatisticData.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing WordStatisticData instance */
    private Builder(com.refactorlabs.cs378.assign5.WordStatisticData other) {
            super(com.refactorlabs.cs378.assign5.WordStatisticData.SCHEMA$);
      if (isValidValue(fields()[0], other.document_count)) {
        this.document_count = data().deepCopy(fields()[0].schema(), other.document_count);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'document_count' field */
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder setDocumentCount(long value) {
    ...
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder clearDocumentCount() {
    ...
    /** Sets the value of the 'total_count' field */
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder setTotalCount(long value) {
    ...
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder clearTotalCount() {
    ...
    /** Sets the value of the 'sum_of_squares' field */
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder setSumOfSquares(long value) {
    ...
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder clearSumOfSquares() {
    ...
    /** Sets the value of the 'mean' field */
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder setMean(double value) {
    ...
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder clearMean() {
    ...
    /** Sets the value of the 'variance' field */
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder setVariance(double value) {
    ...
    public com.refactorlabs.cs378.assign5.WordStatisticData.Builder clearVariance() {
      fieldSetFlags()[4] = false;
      return this;
    }

    @Override
    public WordStatisticData build() {
      try {
        WordStatisticData record = new WordStatisticData();
